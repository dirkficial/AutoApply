...
export function SignInForm({ callbackUrl, registered, verified, reset, urlError }: SignInFormProps) {
          ...
          <form onSubmit={handleCredentials} className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-end">
                <Link href="/forgot-password" className="text-xs text-muted-foreground hover:text-[var(--autoapply-primary)]">
                  Forgot password?
                </Link>
              </div>
            </div>
